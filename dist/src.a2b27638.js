...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"src/Row.js":[function(require,module,exports) {
"use strict";
...
},{"react":"node_modules/react/index.js"}],"src/TableHead.js":[function(require,module,exports) {
"use strict";
...
function TableHead(props) {
  var text = props.text,
      ...
      sortbyInc = props.sortbyInc,
      value = props.value;
  var directionOfSort = selectionStatus == value ? sortbyInc ? "Asc." : "Dsc." : "";
  var highlightStatus = selectionStatus == value ? "selected column" : "column";
  return _react.default.createElement("th", {
    className: highlightStatus,
    value: value,
    onClick: handleClick
  }, text, " ", directionOfSort);
}

var _default = TableHead;
exports.default = _default;
},{"react":"node_modules/react/index.js"}],"src/Example2.js":[function(require,module,exports) {
"use strict";
...
var _TableHead = _interopRequireDefault(require("./TableHead.js"));
...
function (_React$Component) {
  ...
  function Example2() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Example2).call(this));
    _this.state = {
      days: [{
        key: 0,
        // identifier from api
  ...
  _createClass(Example2, [{
    ...
    value: function componentDidMount() {
      ...
      fetch("http://api.openweathermap.org/data/2.5/forecast/daily?q=MountainView&mode=json&units=metric&cnt=14&appid=fe030802c952154e6262bcaeb94017a0").then(function (response) {
        ...
        return _this2.setState({
          days: response.list.map(function (day, index) {
            return {
              key: index,
              dateNumeric: day.dt,
    ...
    value: function handleClick(event) {
      var order = this.state.sortbyInc;
      var value = event.target.getAttribute('value'); // sort list of days according to selected property
      // dates are sorted numerically in the Unix format initially supplied by api

      this.setState(function (prevState) {
        return {
          days: prevState.days.sort(function (a, b) {
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "example-2"
      }, _react.default.createElement("h2", null, "Example 2"), _react.default.createElement("table", {
        className: "table"
      }, _react.default.createElement("thead", null, _react.default.createElement("tr", null, _react.default.createElement(_TableHead.default, {
        value: "dateNumeric",
        handleClick: this.handleClick,
        text: "Date",
        selectionStatus: this.state.currentSort,
        sortbyInc: this.state.sortbyInc
      }), _react.default.createElement("th", null, "Weather"), _react.default.createElement(_TableHead.default, {
        value: "high",
        handleClick: this.handleClick,
  ...
  return Example2;
}(_react.default.Component); // functions are identical between examples but are duplicated for readability purposes


function formatDate(timestamp) {
  var date = formatTimestamp(timestamp);
  var formattedDate = date[1] + " " + date[2] + ", " + date[3];
  return formattedDate; //(formated as "Oct 30, 2018")
...
function formatWeather(weatherObj) {
  var weatherArr = Object.values(weatherObj);
  var weatherDescription = weatherArr.map(function (type) {
    return type.description;
  });
  return weatherDescription.join(" ");
}

var _default = Example2;
exports.default = _default;
},{"react":"node_modules/react/index.js","./Row.js":"src/Row.js","./TableHead.js":"src/TableHead.js"}],"src/Example1.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function Example1() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Example1).call(this));
    _this.state = {
      location: '',
      today: '',
      weather: '',
  ...
  _createClass(Example1, [{
    ...
    value: function componentDidMount() {
      ...
      fetch("//api.openweathermap.org/data/2.5/weather?q=MountainView&units=imperial&appid=fe030802c952154e6262bcaeb94017a0").then(function (response) {
        return response.json();
      }).then(function (response) {
        return _this2.setState({
    ...
    value: function formatTime(timestamp) {
      var date = new Date(timestamp * 1000);
      var dateArray = date.toString().split(' ');
      var timeOnClock = dateArray[4]; //grab time of day in format 00:00:00

      var timeOnClockArr = timeOnClock.split(':');
      var hours = timeOnClockArr[0];
      var ampm = hours > 12 ? "PM" : "AM";
      var standardHour = hours % 12; // convert from military time

      if (standardHour < 10) {
        standardHour = "0" + standardHour;
      }

      var formattedTime = standardHour + ":" + timeOnClockArr[1] + " " + ampm;
      return formattedTime;
    }
  }, {
    key: "render",
    value: function render() {
      var sunrise = this.formatTime(this.state.sunrise);
      var sunset = this.formatTime(this.state.sunset);
      return _react.default.createElement("div", null, _react.default.createElement("h2", null, "Example 1"), _react.default.createElement("p", null, "Location is ", this.state.location), _react.default.createElement("p", null, "Date is ", this.state.today), _react.default.createElement("p", null, "Weather is ", this.state.weather), _react.default.createElement("p", null, "Avg Temperature is ", this.state.temperature, " \xB0F"), _react.default.createElement("p", null, "Humidity is ", this.state.humidity, "%"), _react.default.createElement("p", null, "Windspeed is ", this.state.windspeed, "Mph"), _react.default.createElement("p", null, "Sunrise is ", sunrise), _react.default.createElement("p", null, "Sunset is ", sunset));
    }
  }]);
...
var _Example = _interopRequireDefault(require("./Example2"));

var _Example2 = _interopRequireDefault(require("./Example1"));
...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        className: "App"
      }, _react.default.createElement(_Example2.default, null), _react.default.createElement(_Example.default, null));
    }
  }]);
...
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./Example2":"src/Example2.js","./Example1":"src/Example1.js","./style.css":"src/style.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
